...
(function() {
  ...
  window.view = new (View = (function() {
    ...
    View.prototype.extend = function(methodsConfig, viewsConfig, animationsConfig) {
      this.setMethods(methodsConfig);
      this.setViews(viewsConfig);
      return this.setAnimations(animationsConfig);
    };

    View.prototype.setMethods = function(methodsConfig) {
    ...
    View.prototype.setViews = function(viewsConfig) {
    ...
    View.prototype.setAnimations = function(animationsConfig) {
    ...
    View.prototype.require = function(requiredStates) {
